        ...
        'default' => [
            'web' => [
                'unsecure' => [
                    ...
                    'base_static_url' => 'https://iurii-stepanenko.local/static/',
                    'base_media_url' => 'https://iurii-stepanenko.local/media/'
                ],
                'secure' => [
                    'base_url' => 'https://iurii-stepanenko.local/',
            ...
            'additional_website' => [
                'web' => [
                    'unsecure' => [
                        ...
                        'base_static_url' => 'https://iurii-sky.local/static/',
                        'base_media_url' => 'https://iurii-sky.local/media/'
                    ],
                    'secure' => [
                        'base_url' => 'https://iurii-sky.local/',
                        'base_static_url' => 'https://iurii-sky.local/static/',
